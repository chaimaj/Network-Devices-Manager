  ...
  sticky_relocate();
		...
		<div class="header-content">
		  ...
		  <div align="center" class="logo"><!-- logo--> 
			...
			<a href="accueil-index.php"><img src="../../images/logo.jpg" /></a>
			...
			<nav id="main-nav" align="center">
				<table width="100%" align="center">
                          <tr>
                            <td width="10%" align="center"><a href="accueil-index.php">ACCUEIL</a></td>
                            
                            <td width="30%" align="center"><a href="gestionequipements-index.php">GESTION DES EQUIPEMENTS</a></td>
                            <td width="25%" align="center"><a href="rechercherouteur-index.php">RECHERCHE DE ROUTEUR</a></td>
                            <td width="25%" align="center"><a href="statistiques">STATISTIQUES</a></td>
                            
                            <td width="10%" align="center"><a href="profil-index.php">PROFIL </a></td>
                    </tr>
                        </table>
