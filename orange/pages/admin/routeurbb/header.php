...
<body align="center" id="routeurbb">
			...
			<nav id="main-nav" align="center">
				<table width="100%" align="center">
                          <tr>
                            ...
                            <td width="22%" align="center"><a href="../utilisateurs/index.php">GESTION DES UTILISATEURS </a></td>
...
<nav id="low-nav" align="center">
				<table width="100%" align="center">
                          <tr style="line-height:30px;border-spacing:10px;">
                            <td align="center"><a href="../wimax/index.php">WIMAX</a></td>
                            
                            <td align="center" style="background-color:rgba(199, 186, 186, 0.5);width:0px; box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.6);"></td>
                            
                            <td align="center"><a href="../vsat/index.php">VSAT</a></td>
                            
                            <td align="center" style="background-color: rgba(199, 186, 186, 0.5); width: 0px; box-shadow: 1px 3px 5px rgba(51,51,51,0.6);"></td>
                            
                            <td align="center"><a href="../ipadsl/index.php">IP ADSL</a></td>
                            
                            <td align="center" style="background-color:rgba(199, 186, 186, 0.5);width:0px; box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.6);"></td>
                            
                            <td align="center"><a href="../lsfr/index.php">LS FR</a></td>
                            
                            <td align="center" style="background-color:rgba(199, 186, 186, 0.5);width:0px; box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.6);"></td>
                            
                            <td align="center" id="routeurbbnav"><a href="index.php">ROUTEUR BB</a></td>
                            
                            <td align="center" style="background-color:rgba(199, 186, 186, 0.5);width:0px; box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.6);"></td>
                            
                            <td align="center"><a href="../interfaces/index.php">INTERFACES</a></td>
                            
                            <td align="center" style="background-color:rgba(199, 186, 186, 0.5);width:0px; box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.6);"></td>
                            
                            <td align="center"><a href="../adslpro/index.php">ADSL PRO</a></td>
                            <td align="center" style="background-color:rgba(199, 186, 186, 0.5);width:0px; box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.6);"></td>
                            
                            <td align="center"><a href="../adslentreprise/index.php">ADSL ENTREPRISE</a></td>
                            <td align="center" style="background-color:rgba(199, 186, 186, 0.5);width:0px; box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.6);"></td>
                            
                             <td align="center"><a href="../boutiqueotn/index.php">BOUTIQUE OTN</a></td>
                             
                             <td align="center" style="background-color:rgba(199, 186, 186, 0.5);width:0px; box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.6);"></td>
                             
                            <td align="center"><a href="../entrepriseglob/index.php">ENTREPRISE GLOBALE</a></td>
                    </tr>
                        </table>
