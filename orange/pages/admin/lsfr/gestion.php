...
<tr>
<td>Interface : </td>
<td><center><input type="text" name="interface"/><center></td>
</tr>
<tr>
<td>
Nom du client : 
</td>
<td><center><input type="text" name="nomclient"/><center></td>
</tr>
<tr>
<td>LS : </td>
<td><center>
		<select name="ls" onChange="combo(this,'criticite')">
            <option>Oui</option>
            <option>Non</option>
            </select>
...
<td>FR : </td>
<td><center>
		<select name="fr" onChange="combo(this,'criticite')">
            <option>Oui</option>
            <option>Non</option>
            </select>
