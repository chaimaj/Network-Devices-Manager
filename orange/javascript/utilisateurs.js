...
var editableGrid = new EditableGrid("utilisateurs", {
...
EditableGrid.prototype.initializeGrid = function() 
{
	with (this) {
		...
		setHeaderRenderer("mail", new InfoHeaderRenderer("Note the validator used automatically when you specify your column as being of type email"));
		setHeaderRenderer("admin", new InfoHeaderRenderer("This column tells if the person is an admin or a simple user"));
		...
		setCellRenderer("action", new CellRenderer({render: function(cell, value) {
			...
			cell.innerHTML = "<a onclick=\"if (confirm('Vous &ecirc;tes s&ucirc;re de vouloir supprimer cette ligne ? ')) { editableGrid.deleteRow(" + cell.rowIndex + "); editableGrid.remove(" + cell.rowIndex + ");  editableGrid.renderCharts(); } \" style=\"cursor:pointer\">" +
							 "<img src=\"" + image("delete.png") + "\" border=\"0\" alt=\"delete\" title=\"Supprimer ligne\"/></a>";
...
EditableGrid.prototype.renderCharts = function() 
{
	...
	this.renderPieChart("piechartcontent", 'Admin distribution', 'admin', 'admin');
};
