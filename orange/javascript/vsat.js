...
var editableGrid = new EditableGrid("vsat", {
...
{
	/*this.renderBarChart("barchartcontent", 'Debits' + (this.getRowCount() <= this.maxBars ? '' : ' (Premieres ' + this.maxBars + ' lignes de ' + this.getRowCount() + ')'), 'ST', { limit: this.maxBars, bar3d: false, rotateXLabels: 270 });*/
	this.renderPieChart("piechartcontent", 'Comparaison types', 'type_vsat', 'type_vsat');
};
